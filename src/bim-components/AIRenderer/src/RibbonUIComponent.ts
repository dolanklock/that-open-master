...
export class RibbonUIComponent extends OBC.SimpleUIComponent {
    ...
    constructor(components: OBC.Components) {
        ...
        <bim-toolbar-section label="AI Renderer">
            ...
            <bim-button id="render-settings" vertical label="Render Settings" icon="lets-icons:load-list-light"></bim-button>
            <bim-button id="render-library" vertical label="Library" icon="lets-icons:load-list-light"></bim-button>
        </bim-toolbar-section>
        `
